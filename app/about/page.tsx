  ...
  return (
    <div className="min-h-screen bg-background flex flex-col selection:bg-primary selection:text-background text-foreground">
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <section className="px-4 py-32 border-b border-white/5">
          <div className="max-w-5xl mx-auto space-y-12 text-center">
            ...
            <p className="text-foreground/40 font-sans text-xs uppercase tracking-[0.3em] max-w-2xl mx-auto leading-relaxed">
              At Majestic Hub, we believe in providing exceptional quality products and outstanding customer service—building lasting relationships through trust and reliability.
            </p>
          </div>
        </section>

        {/* Story Section */}
        <section className="px-4 py-48">
          <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24 items-start">
            <div className="space-y-8">
              ...
              <div className="space-y-8 text-foreground/50 font-sans text-sm leading-relaxed tracking-wide">
                <p>
                  Founded with a commitment to excellence, Majestic Hub was established to provide premium products and exceptional customer service. We believe in quality, reliability, and building lasting relationships with our customers.
                </p>
                <p>
                  Every product we offer is carefully selected to meet the highest standards of quality. Our dedication to customer satisfaction drives everything we do, from product selection to after-sales support.
                </p>
              </div>
            </div>
            <div className="space-y-16">
              <div className="p-12 border border-white/5 bg-white/[0.01] space-y-6">
                ...
                <p className="text-foreground/40 text-[10px] uppercase tracking-widest leading-loose">
                  We work exclusively with trusted suppliers who prioritize quality and reliability. Every product is carefully inspected to ensure it meets our high standards.
                </p>
              </div>
              <div className="p-12 border border-white/5 bg-white/[0.01] space-y-6">
        ...
        <section className="px-4 py-48 bg-white/[0.01] border-y border-white/5">
        ...
        {/* CTA Section */}
        <section className="px-4 py-48 text-center">
