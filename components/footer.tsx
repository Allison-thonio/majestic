  ...
  return (
    <footer className="bg-background border-t border-white/5 pt-24 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 lg:gap-16 mb-16 md:mb-24">
          {/* Brand */}
          ...
          <div>
            ...
            <p className="text-foreground/70 text-xs uppercase tracking-widest font-sans mb-4">
              <a href="https://wa.me/2348000000000" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">WhatsApp</a>
            </p>
            <p className="text-foreground/70 text-xs uppercase tracking-widest font-sans mb-4">
              <a href="https://www.google.com/maps/place/Majestic+Hub/@4.9225853,6.2761553,15z" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">Location</a>
            </p>
            <p className="text-foreground/70 text-xs uppercase tracking-widest font-sans mb-4">
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center text-[10px] uppercase tracking-[0.2em] text-foreground/30 font-sans">
          <p>&copy; 2025 Majestic Hub. Excellence in Service.</p>
